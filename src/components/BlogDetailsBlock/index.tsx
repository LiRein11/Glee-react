          ...
          <div className="blog-page__content">
            <div className="blog-item blog-item__detalis">
              <div className="blog-item__box">
                <a href="#">
                  <img className="blog-item__img" src="images/blog/blog-page/1.jpg" alt="blog img"/>
                </a>
                <div className="blog-item__info">
                  <span className="blog-item__date">28 JANUARY, 2020</span>
                  <a className="blog-item__author" href="#">BY ADMIN</a>
                </div>
              </div>
              ...
              <p className="blog-item__text-one">
                ...
                ad minim
                veniam, quis nostrud exercitation ullamco laboris nisi ut alLorem ipsum dolor sit amet, consectetur
                adipisicing elit,
              ...
              <blockquote className="blog-item__blockquote">
                ...
                <span className="blog-item__blockquote-author">
                  Wiusmod tempor
                </span>
              </blockquote>
              <div className="blog-item__content">
                <img className="blog-item__content-img" src="images/blog/blog-detalis/1.jpg" alt="content img"/>
                <div className="blog-item__content-box">
                  <h6 className="blog-item__content-title">
              ...
              <h6 className="blog-item__titletitle">
                Kajtsal jervcm eoaspckred
              </h6>
              ...
              <div className="blog-item__inner">
                <div className="blog-item__left">
                  <div className="blog-item__left-content">
                    <img className="blog-item__left-img" src="images/blog/blog-detalis/2.jpg" alt="img blog detalis"/>
                    <div className="blog-item__left-info">
                      <h5 className="blog-item__left-title">
                        Mark N. Hernandez
                      </h5>
                  ...
                  <div className="blog-item__right-links">
                    <a className="blog-item__right-link" href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="9px"
                        ...
                        <g id="surface1">
                          <path style={{stroke:"none",fillRule:"nonzero",fill:"rgb(161,161,161)",fillOpacity:"1"}}
              ...
              <div className="comments">
                ...
                <div className="comments__comment">
                  <img className="comments__img" src="images/blog/avatar/1.jpg" alt="img avatar"/>
                  <div className="comments__content">
                    <div className="comments__info">
                      <h5 className="comments__info-title">
                        Delores G. Roberts
                      </h5>
                    ...
                    <p className="comments__text">
                      ...
                      convallis. Class aptent
                      taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse orci
                      sem, ultrices
                    </p>
                ...
                <div className="comments__comment comments__comment--active">
                  <img className="comments__img" src="images/blog/avatar/2.jpg" alt="img avatar"/>
                  <div className="comments__content">
                    <div className="comments__info">
                      <h5 className="comments__info-title">
                        Shannon S. Williams
                ...
                <div className="comments__comment">
                  <img className="comments__img" src="images/blog/avatar/3.jpg" alt="img avatar"/>
                  <div className="comments__content">
                    <div className="comments__info">
                      <h5 className="comments__info-title">
                        Nicholas R. Coley
              ...
              <form className="comments__form">
                <div className="comments__form-box">
                  <input className="comments__form-input comments__form-input--name" placeholder="Name" type="text"/>
                  <input className="comments__form-input comments__form-input--email" placeholder="Email" type="text"/>
                </div>
                <textarea className="comments__form-textarea comments__form-textarea--message" placeholder="Comment"></textarea>
  ...
  <div className="container">
    <div className="partners-section__content">
      <div className="partners-section__images">
        <img className="partners-section__images-img" src="images/partners/1.png" alt="partners img"/>
        <img className="partners-section__images-img" src="images/partners/2.png" alt="partners img"/>
        <img className="partners-section__images-img" src="images/partners/3.png" alt="partners img"/>
        <img className="partners-section__images-img" src="images/partners/4.png" alt="partners img"/>
        <img className="partners-section__images-img" src="images/partners/5.png" alt="partners img"/>
      </div>
    </div>
  </div>
</section>
